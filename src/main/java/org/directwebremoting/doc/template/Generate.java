...
public class Generate
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        writeHtmlOutput(pages, root + "/target/publish/dwr/");
        copyStatic(root + "/docs/web/dwr", root + "/target/publish/dwr", new String[] {
    ...
    private static String getTemplateHeaderInsert(Page page)
    {
        ...
        builder.append("  <link rel='shortcut icon' type='image/x-icon' href='");
